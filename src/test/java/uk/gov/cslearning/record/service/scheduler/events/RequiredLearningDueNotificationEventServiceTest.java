...
public class RequiredLearningDueNotificationEventServiceTest {
    ...
    @Test
    public void shouldReturnDoesExist() {
        RequiredLearningDueNotificationEvent requiredLearningDueNotificationEvent = new RequiredLearningDueNotificationEvent();
        requiredLearningDueNotificationEvent.setCourseId("id");
        requiredLearningDueNotificationEvent.setIdentityUid("uid");
        requiredLearningDueNotificationEvent.setPeriod("period");

        requiredLearningDueNotificationEventService.doesExist(requiredLearningDueNotificationEvent);

        verify(requiredLearningDueNotificationEventRepository).findFirstByIdentityUidAndCourseIdAndPeriod(requiredLearningDueNotificationEvent.getIdentityUid(), requiredLearningDueNotificationEvent.getCourseId(), requiredLearningDueNotificationEvent.getPeriod());
    }
}