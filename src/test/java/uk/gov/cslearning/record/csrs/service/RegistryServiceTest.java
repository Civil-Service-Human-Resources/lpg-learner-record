...
public class RegistryServiceTest {
    ...
    private String getResourceByOrgCodeUrl = "%s";
    private String getOrganisationalUnit = "%s";
    ...
    public void setUp() throws Exception {
        ...
        registryService = new RegistryService(restOperations, requestEntityFactory, getCurrentUrl, getResourceByUidUrl, findByUidUrlFormat, getResourceByOrgCodeUrl, getOrganisationalUnit);
    }
