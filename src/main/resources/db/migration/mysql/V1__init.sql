...
CREATE TABLE `course_record_module_records` (
  ...
  KEY `FK_course_record_module_records_course_record_course_id` (`course_record_course_id`),
  KEY `FK_course_record_module_records_course_record_user_id` (`course_record_user_id`),
  KEY `FK_course_record_module_records_module_records` (`module_records_id`),
