...
INSERT INTO course_record (course_id, user_id, state, preference, profession, department, last_updated, course_title,
                           is_required)
VALUES ('testCourse2', 'user1', 'IN_PROGRESS', null, null, null, '2023-02-02 12:00:00', 'Course 2', 0);
INSERT INTO course_record (course_id, user_id, state, preference, profession, department, last_updated, course_title,
                           is_required)
VALUES ('testCourse3', 'user2', 'IN_PROGRESS', null, null, null, '2023-01-01 10:00:00', 'Course 3', 0);
INSERT INTO course_record (course_id, user_id, state, preference, profession, department, last_updated, course_title,
                           is_required)
VALUES ('testCourse1', 'user2', 'IN_PROGRESS', null, null, null, '2023-02-02 12:00:00', 'Course 1', 1);
