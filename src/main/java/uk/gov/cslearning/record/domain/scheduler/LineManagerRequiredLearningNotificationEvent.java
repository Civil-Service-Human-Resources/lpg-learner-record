...
public class LineManagerRequiredLearningNotificationEvent {
    ...
    public LineManagerRequiredLearningNotificationEvent(String lineManagerUsername, String name, String uid, String courseId, String courseTitle, Instant createdAt) {
