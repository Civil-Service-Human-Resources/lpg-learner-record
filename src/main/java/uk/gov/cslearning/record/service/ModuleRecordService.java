...
public class ModuleRecordService {
    ...
    public ModuleRecord updateModuleRecord(Long moduleRecordId, JsonPatch patch) {
        ...
        if(patch != null) {
            log.debug("LC-1627: ModuleRecordService.updateModuleRecord.received patch: {} ", patch.toString());
        } else {
            log.debug("LC-1627: ModuleRecordService.updateModuleRecord.received patch is null");
        }
        ...
        if(moduleRecord != null) {
            ...
            log.debug("LC-1627: ModuleRecordService.updateModuleRecord. existing moduleRecord is null");
        }
        ...
        if(existingRecordAsInput != null) {
            ...
            log.debug("LC-1627: ModuleRecordService.updateModuleRecord. existingRecordAsInput is null");
        }
        ...
        if(patchedInput != null) {
            ...
            log.debug("LC-1627: ModuleRecordService.updateModuleRecord. patchedInput is null");
        }
        ...
        if(moduleRecord != null) {
            ...
            log.debug("LC-1627: ModuleRecordService.updateModuleRecord.moduleRecord is null");
        }
        ...
        if(savedModuleRecord != null) {
            ...
            log.debug("LC-1627: ModuleRecordService.updateModuleRecord.savedModuleRecord is null");
        }
    ...
    public ModuleRecord createModuleRecord(PostModuleRecordInput newModuleInput) {
        ...
        if(newModule != null) {
            ...
            log.debug("LC-1627: ModuleRecordService.createModuleRecord. before save updated newModule is null.");
        }
        ...
        if(savedModuleRecord != null) {
            ...
            log.debug("LC-1627: ModuleRecordService.createModuleRecord. savedModuleRecord is null.");
        }
