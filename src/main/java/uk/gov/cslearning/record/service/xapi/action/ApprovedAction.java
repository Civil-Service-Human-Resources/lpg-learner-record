...
public class ApprovedAction extends Action {

    private static final Logger LOGGER = LoggerFactory.getLogger(ApprovedAction.class);

    private static final String CALL_OFF_PREFIX = "Call off";

    static {
        Action.register(ApprovedAction.class, ActivityType.EVENT, Verb.APPROVED);
    }

    ApprovedAction(Statement statement) {
        super(statement);
    }
